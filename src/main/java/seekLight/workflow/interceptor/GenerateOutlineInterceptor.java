...
public class GenerateOutlineInterceptor implements PluginInterceptor<WorkFlowContext, Map<String,String>>{
    ...
    public void afterFetch(WorkFlowContext flow, Map<String,String> data) throws Exception {
        ...
        String question = "根据提示，写一个故事的大纲，提示: "+data.get("Generator_title");
        String result = new OllamaClient(role).chat(rules, question, role, 2);
        log.info("GenerateOutline-最终结果: \n{}",result);
        flow.putParam("GenerateOutline_content",result);
    }
}
