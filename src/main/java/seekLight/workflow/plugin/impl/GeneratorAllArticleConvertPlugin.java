...
import seekLight.workflow.interceptor.GeneratorAllArticleConvertInterceptor;
...
@Component
public  class GeneratorAllArticleConvertPlugin extends AbstractPlugin<WorkFlowContext, Map<String,String>> {
    @Override
    public Fetcher getFetcher() {
        return new FetcherChain<WorkFlowContext, Map<String,String>>().add(new BaseMapFetcher());
    }

    public GeneratorAllArticleConvertPlugin(GeneratorAllArticleConvertInterceptor generateOutlineInterceptor) {
        this.addInterceptor(generateOutlineInterceptor);
    }

    @Override
    public String getName() {
        return "GeneratorAllArticleConvert";
    }
}
