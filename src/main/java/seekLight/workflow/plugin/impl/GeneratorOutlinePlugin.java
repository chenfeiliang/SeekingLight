...
import seekLight.workflow.interceptor.GenerateOutlineInterceptor;
...
@Component
public  class GeneratorOutlinePlugin extends AbstractPlugin<WorkFlowContext, Map<String,String>> {
    @Override
    public Fetcher getFetcher() {
        return new FetcherChain<WorkFlowContext, Map<String,String>>().add(new BaseMapFetcher());
    }

    public GeneratorOutlinePlugin(GenerateOutlineInterceptor generateOutlineInterceptor) {
        this.addInterceptor(generateOutlineInterceptor);
    }

    @Override
    public String getName() {
        return "GeneratorOutline";
    }
}
