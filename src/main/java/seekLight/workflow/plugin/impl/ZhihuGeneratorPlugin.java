...
import seekLight.workflow.interceptor.ZhiHuGeneratorInterceptor;
import seekLight.workflow.plugin.AbstractPlugin;

import java.util.Map;
@Component
public  class ZhihuGeneratorPlugin extends AbstractPlugin<WorkFlowContext, Map<String,String>> {
    @Override
